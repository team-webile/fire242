...
class DuplicateVoterController extends Controller 
{
   ...
   public function getDuplicateVoters(Request $request)
   {
        ...
        return Excel::download(new DuplicateVoterExport($voters, $request, $columns), 'Duplicate Voters_' . $timestamp . '.xlsx');  

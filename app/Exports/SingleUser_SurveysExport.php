...
class SingleUser_SurveysExport implements FromCollection, WithHeadings, WithStyles
{
    protected $surveys;
    protected $request;
    protected $columns;
    ...
    public function collection()
    {
        return $this->surveys->map(function ($survey) {
            ...
            if (in_array('created at', $this->columns)) {
                $row['Survey At'] = $survey->created_at;
            }
    ...
    public function headings(): array
    {
        ...
        foreach($this->columns as $column) {
            switch(strtolower($column)) {
                ...
                case 'created at': $headers[] = 'Survey At'; break;
            }
        }
        return $headers;
    }

...
class UpcomingBirthdaysExport implements FromCollection, WithHeadings, WithStyles
{
    protected $voters;
    protected $request;
    protected $columns;
            ...
            foreach ($this->columns as $column) {
                switch (strtolower($column)) {
                    ...
                    case 'last name':
                        ...
                        break;
                    case 'phone number': 
                        $row['phone number'] = $voter->cell_phone_code . $voter->cell_phone; 
                        break;
                    case 'is surveyed':
                        $row['is surveyed'] = $voter->is_surveyed ? 'Yes' : 'No';
                        break;
                    case 'is contacted':
                        $row['is contacted'] = $voter->is_contacted ? 'Yes' : 'No';
                        break;
                    case 'date of birth':
